...
module.exports = function (commands) {
  ...
  function createPckgJson () {
    create.pckg(defaultOptions.moduleName, defaultOptions.mainFile, null, defaultOptions.gitRepo, path.join(defaultOptions.folderPath, 'package.json'), function (err) {
      if(err) return logError(err);
      createViewIfExists();
    });
  }
